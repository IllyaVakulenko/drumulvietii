...
class About_Us extends Abstract_Module {
	...
	public function add_submenu_pages() {
		...
		add_submenu_page(
			...
			__( 'About Us', 'themeisle-companion' ),
			__( 'About Us', 'themeisle-companion' ),
			'manage_options',
	...
	private function get_about_localization_data() {
		...
		return [
			...
			'strings'            => [
				'aboutUs'          => __( 'About us', 'themeisle-companion' ),
				'heroHeader'       => __( 'Our Story', 'themeisle-companion' ),
				'heroTextFirst'    => __( 'Themeisle was founded in 2012 by a group of passionate developers who wanted to create beautiful and functional WordPress themes and plugins. Since then, we have grown into a team of over 20 dedicated professionals who are committed to delivering the best possible products to our customers.', 'themeisle-companion' ),
				'heroTextSecond'   => __( 'At Themeisle, we offer a wide range of WordPress themes and plugins that are designed to meet the needs of both beginners and advanced users. Our products are feature-rich, easy to use, and are designed to help you create beautiful and functional websites.', 'themeisle-companion' ),
				'teamImageCaption' => __( 'Our team in WCEU2022 in Portugal', 'themeisle-companion' ),
				'newsHeading'      => __( 'Stay connected for news & updates!', 'themeisle-companion' ),
				'emailPlaceholder' => __( 'Your email address', 'themeisle-companion' ),
				'signMeUp'         => __( 'Sign me up', 'themeisle-companion' ),
				'installNow'       => __( 'Install Now', 'themeisle-companion' ),
				'activate'         => __( 'Activate', 'themeisle-companion' ),
				'learnMore'        => __( 'Learn More', 'themeisle-companion' ),
				'installed'        => __( 'Installed', 'themeisle-companion' ),
				'notInstalled'     => __( 'Not Installed', 'themeisle-companion' ),
				'active'           => __( 'Active', 'themeisle-companion' ),
			],
	...
	private function get_product_pages_data( $product_pages ) {
		...
		$pages = [
			'otter-page' => [
				...
				'plugin'  => $otter_plugin,
				'strings' => [
					'heading'      => __( 'Build innovative layouts with Otter Blocks and Gutenberg', 'themeisle-companion' ),
					'text'         => __( 'Otter is a lightweight, dynamic collection of page building blocks and templates for the WordPress block editor.', 'themeisle-companion' ),
					'buttons'      => [
						'install_otter_free' => __( "Install Otter - It's free!", 'themeisle-companion' ),
						'install_now'        => __( 'Install Now', 'themeisle-companion' ),
						'learn_more'         => __( 'Learn More', 'themeisle-companion' ),
						'learn_more_link'    => tsdk_utmify( 'https://themeisle.com/plugins/otter-blocks/', 'otter-page', 'about-us' ),
					],
					'features'     => [
						'advancedTitle' => __( 'Advanced Features', 'themeisle-companion' ),
						'advancedDesc'  => __( 'Add features such as Custom CSS, Animations & Visibility Conditions to all blocks.', 'themeisle-companion' ),
						'fastTitle'     => __( 'Lightweight and Fast', 'themeisle-companion' ),
						'fastDesc'      => __( 'Otter enhances WordPress site building experience without impacting site speed.', 'themeisle-companion' ),
						'mobileTitle'   => __( 'Mobile-Friendly', 'themeisle-companion' ),
						'mobileDesc'    => __( 'Each block can be tweaked to provide a consistent experience across all devices.', 'themeisle-companion' ),
					],
					'details'      => [
						's1Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-builder.png',
						's1Title' => __( 'A Better Page Building Experience', 'themeisle-companion' ),
						's1Text'  => __( 'Otter can be used to build everything from a personal blog to an e-commerce site without losing the personal touch. Otter’s ease of use transforms basic blocks into expressive layouts in seconds.', 'themeisle-companion' ),
						's2Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-patterns.png',
						's2Title' => __( 'A New Collection of Patterns', 'themeisle-companion' ),
						's2Text'  => __( 'A New Patterns Library, containing a range of different elements in a variety of styles to help you build great pages. All of your website’s most important areas are covered: headers, testimonials, pricing tables, sections and more.', 'themeisle-companion' ),
						's3Image' => $this->get_sdk_uri() . 'assets/images/otter/otter-library.png',
						's3Title' => __( 'Advanced Blocks', 'themeisle-companion' ),
						's3Text'  => __( 'Enhance your website’s design with powerful blocks, like the Add to Cart, Business Hours, Review Comparison, and dozens of WooCommerce blocks.', 'themeisle-companion' ),
					],
					'testimonials' => [
						'heading' => __( 'Trusted by more than 300K website owners', 'themeisle-companion' ),
						'users'   => [
							[
	...
	private function get_other_products_data() {
		$products = [
			...
			'neve'                                => [
				'skip_api'    => true,
				'name'        => 'Neve',
				'description' => __( 'A fast, lightweight, customizable WordPress theme offering responsive design, speed, and flexibility for various website types.', 'themeisle-companion' ),
			...
			'sparks-for-woocommerce'              => [
				...
				'name'        => 'Sparks',
				'description' => __( 'Extend your store functionality with 8 ultra-performant features like product comparisons, variation swatches, wishlist, and more.', 'themeisle-companion' ),
				'icon'        => $this->get_sdk_uri() . 'assets/images/sparks.png',
				'condition'   => class_exists( 'WooCommerce', false ),
			],
			'templates-patterns-collection'       => [
				'name'        => 'Templates Cloud',
				'description' => __( 'Design, save, and revisit your templates anytime with your personal vault on Templates Cloud.', 'themeisle-companion' ),
			],
		];
